    ...
    try {
        for (const scenario of ['valid', 'unavailable', 'invalid']) {
            ...
            try {
                ...
                await page.goto(BASE); await page.waitForFunction(() => state.songs.length === 2 && !songbookLoadPending);
                ...
                if (scenario === 'valid') {
                    ...
                    await page.reload(); await page.waitForFunction(() => state.songs.length === 2 && !songbookLoadPending);
